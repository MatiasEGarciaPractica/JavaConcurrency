...
public class DequeueMethods {
	...
	public static void main(String[] args) {
		...
		String elmeent2 = blockingQueue.poll();
		
		//poll(long timeout, TimeUnit timeUnit) blocks up until timeout for an element to become available. If no element is available
